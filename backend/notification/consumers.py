...
#     print(create_notification,"mmmmmmmmm")
...
#                 }))
#                 print(text_data,"data sendeddddddddd")
#             else:
#                 print("Invalid message format: 'recipient_id' or 'content' is missing.")
#         except json.JSONDecodeError:
#             print("Invalid JSON format in the received data.")
...
# ith pakka annuu 2nd one,now weadding get channel layer
        ...
        try:
            ...
            if recipient_id is not None and content is not None:
                ...
                await channel_layer.group_send(
                    ...
                    {
                        'type': 'send_notification',  # Event type
                        'recipient': recipient_data,
                        'notification': notification_data,
                    }
                )
